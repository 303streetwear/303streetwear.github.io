...
ytcfg.set({
    ...
    "INNERTUBE_CLIENT_VERSION": "2.20230217.01.00",
    "INNERTUBE_CONTEXT": {
        "client": {
            "clientName": "WEB",
    ...
    "INNERTUBE_CONTEXT_CLIENT_VERSION": "2.20230217.01.00",
...
if (self.trustedTypes && self.trustedTypes.createPolicy) {
    const swPolicy = trustedTypes.createPolicy('youtubeServiceWorkerPolicy', {
        createScriptURL: function(ignored) {
            return 'https:\/\/www.youtube.com\/s\/desktop\/b95ddd88\/jsbin\/serviceworker-kevlar-appshell.vflset\/serviceworker-kevlar-appshell.js';
        }
    });
    importScripts(swPolicy.createScriptURL(''));
} else {
    importScripts('https:\/\/www.youtube.com\/s\/desktop\/b95ddd88\/jsbin\/serviceworker-kevlar-appshell.vflset\/serviceworker-kevlar-appshell.js');
}